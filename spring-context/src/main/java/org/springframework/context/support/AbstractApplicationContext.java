...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				// 初始化应用信息广播器，并放入 "applicationEventMulticaster" bean 中
				...
				// 在所有注册的bean中查找 Listener bean，注册到信息广播器中
	...
	protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		...
		// 主要是对bean实例化后执行初始化方法之后调用的 postProcessAfterInitialization 方法
	...
	protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		...
		// getBeanFactoryPostProcessors() 为程序员手动注册的beanFactoryPostProcessor
		// （即调用BeanFactory的addBeanFactoryPostProcessor方法进行注册的）
	...
	/**
	 * 如果 get 的这个 name 所对应的 bean 已经存在 mapdb 当中，但是没有被 spring 实例化，则会被实例化
	 * 如果 get 的这个 name 所对应的 bean 没有存在 mapdb 当中，就会报错
