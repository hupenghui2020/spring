...
class ConfigurationClassBeanDefinitionReader {
	...
	private void loadBeanDefinitionsForConfigurationClass(
		...
		// 不应该跳过的条件：
		// 1、configClass 是被带 @Import 注解的类导入进来的，
		//  并且带 @Import 注解的类没有 @Condition 注解或者条件结果为 true（也就是满足注册条件）
		// 2、configClass 上有 @Condition 注解，条件结果为 true（也就是满足注册条件）
